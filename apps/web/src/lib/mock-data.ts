...
export type Municipality = {
  id: string
  name: string
  jurisdictionType: "City" | "Regional District" | "District Municipality" | "Province"
  state: string
}
...
export const municipalities: Municipality[] = [
  { id: "vancouver-city", name: "Vancouver, BC", jurisdictionType: "City", state: "BC" },
  { id: "surrey-city", name: "Surrey, BC", jurisdictionType: "City", state: "BC" },
  { id: "burnaby-city", name: "Burnaby, BC", jurisdictionType: "City", state: "BC" },
  { id: "metrovan-rd", name: "Metro Vancouver Regional District, BC", jurisdictionType: "Regional District", state: "BC" },
  { id: "victoria-city", name: "Victoria, BC", jurisdictionType: "City", state: "BC" },
  { id: "northvan-city", name: "North Vancouver, BC", jurisdictionType: "City", state: "BC" },
  { id: "richmond-city", name: "Richmond, BC", jurisdictionType: "City", state: "BC" },
  { id: "coquitlam-city", name: "Coquitlam, BC", jurisdictionType: "City", state: "BC" },
  { id: "mapleridge-city", name: "Maple Ridge, BC", jurisdictionType: "District Municipality", state: "BC" },
]
...
export const projects: Project[] = [
  {
    id: "p1",
    code: "3EEC8",
    name: "Mount Pleasant Office Fit-Out",
    address: "121 W 7th Ave",
    city: "Vancouver",
    state: "BC",
    zip: "V5T 1M5",
    municipalities: ["vancouver-city"],
    types: ["Commercial"],
    team: ["u1"],
  ...
  },
  {
    id: "p2",
    code: "E7742",
    name: "Whalley Cafe Interior Refresh",
    address: "1518 King George Blvd",
    city: "Surrey",
    state: "BC",
    zip: "V3T 5C5",
    municipalities: ["surrey-city"],
  ...
  },
  {
    id: "p3",
    code: "51881",
    name: "Metrotown Office Space Upgrade",
    address: "1767 Kingsway",
    city: "Burnaby",
    state: "BC",
    zip: "V5H 4N9",
    municipalities: ["burnaby-city", "metrovan-rd"],
    types: ["General Improvements"],
    team: ["u4"],
  ...
  },
  {
    id: "p4",
    code: "BA4A5",
    name: "Fairfield Drive-thru Remodel",
    address: "137 Fairfield Rd",
    city: "Victoria",
    state: "BC",
    zip: "V8V 4T7",
    municipalities: ["victoria-city"],
    types: ["General Improvements"],
    team: ["u3"],
    status: "permit_pending",
  ...
  },
  {
    id: "p5",
    code: "25F31",
    name: "Lonsdale Commercial Tenant Improvement",
    address: "1510 Lonsdale Ave",
    city: "North Vancouver",
    state: "BC",
    zip: "V7M 2J3",
    municipalities: ["northvan-city", "metrovan-rd"],
  ...
  },
  {
    id: "p7",
    code: "5D6D1",
    name: "Solar Panel Installation — Richmond Site",
    address: "361 Cambie Rd",
    city: "Richmond",
    state: "BC",
    zip: "V6Y 2B3",
    municipalities: ["richmond-city"],
    types: ["Signage"],
    team: ["u1"],
    status: "permit_pending",
  ...
  },
  {
    id: "p10",
    code: "39DCB",
    name: "Evan's Kits Beach Remodel",
    address: "1510 W 4th Ave",
    city: "Vancouver",
    state: "BC",
    zip: "V6J 1H7",
    municipalities: ["vancouver-city"],
...
export const permits: Permit[] = [
  {
    ...
    status: "preparing",
    tags: ["Walls"],
    issuingMunicipalityId: "vancouver-city",
    submitterId: "u1",
    assigneeIds: [],
    reviewerIds: [],
    description:
  ...
  },
  {
    ...
    status: "submitted",
    tags: ["Roof"],
    issuingMunicipalityId: "surrey-city",
    submitterId: "u4",
    assigneeIds: ["u4"],
    reviewerIds: ["u6"],
  ...
  },
  {
    ...
    status: "in_review",
    tags: ["Site"],
    issuingMunicipalityId: "northvan-city",
    submitterId: "u1",
    assigneeIds: ["u1"],
    reviewerIds: ["u6"],
  ...
  },
  {
    ...
    issuingMunicipalityId: "richmond-city",
    submitterId: "u1",
    assigneeIds: ["u1"],
    reviewerIds: ["u6"],
...
export const requiredForms: RequiredForm[] = [
  ...
  { id: "f6", name: "Energy Step Code Compliance Form (BCBC §9.36)", submissionRequired: false, externalInputs: true },
]
...
export const assumptions: Assumption[] = [
  {
    id: "a1",
    category: "Market",
    title: "BC-first wedge, North American TAM",
    body:
      "Permitflow is US-based out of New York and not in Canada yet. BC municipalities prefer working with Canadian companies — a real local-preference moat Permitflow doesn't have here. We start in BC (team is closest, no incumbent doing this), then expand across Canada, then into the broader North American market over time. Going global is explicitly off the roadmap.",
    confidence: "High",
    evidence:
      "Paul, 2026-05-27 call. 'There's nobody in Canada at this current time doing what we're doing.' Plus: 'We wanna focus here just in the North American market.' BC is the wedge; NA is the TAM.",
  },
  {
    id: "a2",
    category: "Market",
