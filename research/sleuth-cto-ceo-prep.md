...
> "Fourteen years, almost all early-stage data and AI startups. The one that maps directly to Sleuth is Acies.ai — I was founding designer on a BI platform for payments, huge datasets, predictive AI, and the real problem was getting skeptical analysts to trust what the model produced. That's your problem. More recently I was Senior Product Designer for Platform & AI at Sprig — set AI direction, rebuilt the design system. And outside client work I ship AI-native products weekly with Claude Code — a node-based AI pipeline builder, my own agent command-and-observability tooling. AI-centric is how I already work, not a skill I'm adding."

### 2. "What does AI-centric design mean to you?" (THE Sleuth question)
> "Two halves. In the product: AI-native patterns — streaming, source attribution, reversible state, progressive disclosure of reasoning — instead of a database UI with a chat box bolted on. In my workflow: AI-forward tools by default — Claude wired into Figma for design-system and token work, agents for research synthesis, prototyping with AI in the loop. And I have an 'AI Product Design Patterns' certification plus a shelf of shipped AI-native side projects — a flow-builder, agent tooling, a token system — so this is demonstrated, not claimed. You told Namartha the gap with the current designer is exactly this. It's my edge: data-heavy depth *plus* modern AI fluency, and I live in the tooling, I don't observe it."
