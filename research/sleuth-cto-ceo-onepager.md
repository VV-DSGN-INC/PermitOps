# Sleuth CTO/CEO Round — One-Page Cheat Sheet

**Positioning line (open and close with this):**
> "I'm the AI-native, data-heavy product designer who makes skeptical experts trust AI output — and I live in AI tooling, I don't just design it."

**The 4 delivery rules (the fix for what went wrong in round 1):**
1. Headline first → 3 beats → **stop**. Sentence one IS the answer.
2. Never volunteer a weakness. Not "behind on AI," not "less research than I wanted."
3. Never "it depends." Always "My default is X; it flexes to Y when Z."
4. Portfolio = one decision + the rejected alternative + why. Never a screen tour.
...
- *Data-heavy product* → "The hard part of a data product isn't the dashboard, it's making one trusted decision fast."
...
**Ask them (same Q to CTO and CEO; mismatch = the real risk):**
...
- "Long-term, is self-serve the bet or is concierge the moat?"
- "Riskiest assumption in the product right now that design could de-risk?"

**If a design exercise comes (likely: knowledge-graph exploration or insight→presentation):** clarify → name the user (skeptical BD/S&E analyst) → trust primitives first → one flow → success metric → name a tradeoff → "want me to go deeper?"

**Energy:** calm, specific, senior-who's-seen-enough. Concrete nouns, real project names, zero invented metrics. 45–90 sec per answer, then stop.
